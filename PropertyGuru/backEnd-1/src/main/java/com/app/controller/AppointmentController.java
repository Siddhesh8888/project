...
public class AppointmentController {
	...
	public List<Appointment> showAllAppointmentsOfOwner(@PathVariable Long ownerid) throws resourceNotFoundException{
		return  appServ.showAllAppointmentsOfOwner(ownerid);
